...
import LoadingSpinner from '../Components/Loading/FaceLoading';

const PrivateRoute = ({ children }) => {
  const { getUserRole } = Context();
  ...
  if (loading) {
    return <LoadingSpinner /> // feliz (default);  // O cualquier otro indicador de carga que prefieras
  }
